  ...
  return (
    <div className="mx-auto max-w-[920px] px-[22px] pt-10 pb-[90px]">
      ...
      <div ref={introRef}>
        ...
        >
          A team with <strong className="text-accent-500">15+ years</strong> of counselling experience has grown that
          into a network of <strong className="text-accent-500">5,000+ associate institutes</strong>, colleges and
          universities — built through actual campus visits, not just brochures. We maintain an exclusive Board of
          Studies input for every discipline, so the guidance reflects what colleges and industry currently expect,
          not what was true a decade ago.
        </p>
        <p
        ...
        >
          ...
          (Sundays by appointment), and we still offer virtual campus tours for families who can&apos;t travel to see
          a college in person.
        </p>
      </div>
