...
import type { PublicScholarship } from "@/lib/site-data";
...
export function ScholarshipsClient({
  ...
  const [results, setResults] = useState<PublicScholarship[] | null>(null);
  ...
  const checkEligibility = (e: React.FormEvent) => {
    ...
    setResults(scholarships.filter((sc) => sc.income === inc && (!sc.streamKey || sc.streamKey === stream)));
  };
