  ...
  return (
    <section className="relative isolate overflow-hidden bg-primary-900">
      ...
      <div
        className={
          isMobile
            ? "relative z-10 mx-auto flex max-w-[1220px] flex-col gap-7 px-[22px] pt-11 pb-10"
            : "relative z-10 mx-auto flex max-w-[1260px] flex-row items-start justify-between gap-12 px-[22px] pt-[90px] pb-20"
        }
      >
        <div className={isMobile ? "max-w-full" : "max-w-[560px] flex-1 pt-1.5"} style={!isMobile ? { flex: "1 1 480px" } : undefined}>
          <div
            className="mb-5.5 inline-flex items-center gap-2 rounded-full border border-white/25 bg-white/10 px-4 py-2 text-[13px] font-bold text-white backdrop-blur-sm"
          ...
          <h1
            className="mb-5 text-[clamp(30px,4.4vw,50px)] leading-[1.12] font-extrabold text-white"
          ...
          <p
            className="mb-7 max-w-[52ch] text-[17px] leading-relaxed text-white/85"
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2.5 rounded-[11px] border-[1.5px] border-white/40 bg-white px-[22px] py-3.5 text-base font-bold text-primary-900 no-underline"
            >
              <span aria-hidden>💬</span>
          ...
          >
            {heroStats.map((s) => (
              <div key={s.label}>
                <div className="inline-block border-b-4 border-highlight-500 pb-1.5 text-[26px] leading-none font-extrabold text-white">
                  {s.value}
                </div>
